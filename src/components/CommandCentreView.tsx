    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 relative z-10">
          <div>
            ...
            <p className="text-xs text-[#8890a6] mt-1">
              Unified CTO / CIO / CISO oversight across multi-tenant SLAs, AI throughput, financial burn, and statutory POPIA/GDPR guardrails.
            </p>
          </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          ...
          <span className="text-[11px] font-mono text-[#555e78]">Global SLA Target: ≥ 99.95%</span>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
          <div className="bg-[#12141c] border border-[#222636] p-3.5 rounded-lg">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
          ...
          <div className="bg-[#12141c] border border-[#222636] p-3.5 rounded-lg">
            ...
            <span className="text-[10px] text-amber-400/90 font-mono mt-0.5 block">≈ R{(totalSpend * 18).toFixed(0)} ZAR</span>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="bg-[#12141c] border border-[#222636] rounded-xl p-4 space-y-3">
          ...
          <div className="grid grid-cols-3 gap-2.5">
            ...
            <div className="bg-[#181c28] p-3 rounded-lg border border-[#283046]">
              <span className="text-[10px] text-[#77809a] uppercase font-semibold block">PII Incidents Scrubbed</span>
              <span className="text-base font-bold text-blue-400 font-mono">1,240</span>
            </div>
            <div className="bg-[#181c28] p-3 rounded-lg border border-[#283046]">
              <span className="text-[10px] text-[#77809a] uppercase font-semibold block">Prompt Injections</span>
        ...
        <div className="bg-[#12141c] border border-[#222636] rounded-xl p-4 space-y-3">
          ...
          <div className="grid grid-cols-3 gap-2.5">
            ...
            <div className="bg-[#181c28] p-3 rounded-lg border border-[#283046]">
              <span className="text-[10px] text-[#77809a] uppercase font-semibold block">DSARs Outstanding</span>
